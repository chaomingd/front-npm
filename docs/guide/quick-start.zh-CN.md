...
## 介绍
@chaomingd/design：组件库

@chaomingd/charts：图表库

@chaomingd/hooks：react hooks库

@chaomingd/utils：utils工具库

@chaomingd/store：react状态管理库
...
<br />
<NormalInstallDependencies packageNames="@chaomingd/design @chaomingd/hooks @chaomingd/utils @chaomingd/store" save="true"></NormalInstallDependencies>
